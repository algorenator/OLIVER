--
-- MERGE_MEMBER_PENSION_040418  (Procedure) 
--
CREATE OR REPLACE PROCEDURE OLIVER.MERGE_MEMBER_PENSION_040418 (
...
BEGIN
   ...
   IF
        C2%NOTFOUND
    THEN
        RAISE_APPLICATION_ERROR(-20000,'ID of Incorrect member does not exist');
    END IF;
...
*/
    ...
    CLOSE A2;
END MERGE_MEMBER_PENSION_040418;
/
