--
-- PKG_EXCEL_FILE  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY OLIVER.PKG_EXCEL_FILE
is
--
...
ts timestamp := systimestamp;
  begin
    dbms_lob.createtemporary( t_excel, true, DBMS_LOB.SESSION );
...
<bookViews>
<workbookView xWindow="520" yWindow="445" windowWidth="19155" windowHeight="4935"/>
</bookViews>
<sheets>';
    for s in 1 .. workbook.sheets.count()
    loop
