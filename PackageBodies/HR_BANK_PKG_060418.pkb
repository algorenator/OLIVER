--
-- HR_BANK_PKG_060418  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY OLIVER.HR_BANK_PKG_060418 AS
        ...
        LOOP
            ...
            LOOP
                ...
                ELSE
                    UPDATE TBL_PENMAST
                        SET
                            PENM_LRD = GREATEST(NVL(PENM_LRD,HEAD_REC.THTP_END_DATE),HEAD_REC.THTP_END_DATE),
                            PENM_EMPLOYER = DET_REC.TDT_EMPLOYER
                    WHERE
                        PENM_CLIENT = CLT_ID
                        AND   PENM_PLAN = PL_ID
                        AND   PENM_ID = DET_REC.TDT_MEM_ID
                ...
                BEGIN
                    ...
                    THEN
                        ...
                        WHERE
                            ...
                            AND   ANN_ID = DET_REC.TDT_MEM_ID
                            AND   ANN_YEAR = TO_NUMBER(TO_CHAR(HEAD_REC.THTP_END_DATE,'rrrr') )
                            AND   NVL(ANN_ACCOUNT,'XX') = NVL(HEAD_REC.THTP_VOL_ACCOUNT,'XX');
