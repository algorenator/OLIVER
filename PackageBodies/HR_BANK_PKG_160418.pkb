--
-- HR_BANK_PKG_160418  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY OLIVER.HR_BANK_PKG_160418 AS
    ...
    BEGIN
        ...
        LOOP
            ...
            LOOP
                ...
                INSERT INTO TBL_MEM_PEN_STATUS_HIST(TMPSH_CLIENT,TMPSH_PLAN,TMPSH_MEM_ID,TMPSH_STATUS,TMPSH_STATUS_DATE) VALUES  (CLT_ID,PL_ID,DET_REC.TDT_MEM_ID,ST,ST_DATE);
                ST:='C';
                ST_DATE:=HEAD_REC.THTP_START_DATE;
  ...
  -- UPDATE TRANSACTION_DETAIL_TEMP SET DTF_POST='Y' WHERE DTF_PLAN_ID=PL_ID AND DTF_USER=USER_ID AND DTF_TRAN_ID=HEAD_REC.THTF_TRAN_ID;
    ...
    BEGIN
        ...
        LOOP
            ...
            SELECT
                greatest(max1,greatest(MAX(TRUNC(PL_HW_MONTHEND,'MM') ),mth) )
            INTO
                MAX1
            FROM
                TBL_PLAN
