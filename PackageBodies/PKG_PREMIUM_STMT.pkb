--
-- PKG_PREMIUM_STMT  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY OLIVER.PKG_PREMIUM_STMT
IS
   ...
   BEGIN
      ...
      DELETE FROM MEMBER_BENEFITS_TEMP
            WHERE client_id = p_client_id AND plan_id = p_plan_id and  employer=P_EMPLOYER_ID;

      INSERT INTO MEMBER_BENEFITS_TEMP (BM_BEN_GROUP,
                                        EMPLOYER,
                                        BM_BEN_TYPE,
                                        CLIENT_ID,
                                        PLAN_ID,
