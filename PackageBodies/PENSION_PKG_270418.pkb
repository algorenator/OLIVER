--
-- PENSION_PKG_270418  (Package Body) 
--
CREATE OR REPLACE PACKAGE BODY OLIVER.PENSION_PKG_270418 AS
...
LOOP 
  FETCH C INTO REC;
  EXIT WHEN C%NOTFOUND;
  SELECT MAX(PENM_STATUS),MAX(PENM_STATUS_DATE) INTO ST,STDATE FROM TBL_PENMAST WHERE PENM_CLIENT=CLT_ID AND PENM_PLAN=PL_ID AND PENM_ID=EE_ID;
