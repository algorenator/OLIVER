--
-- TMP_TBL_COMPPEN_AG1  (Table) 
--
CREATE TABLE OLIVER.TMP_TBL_COMPPEN_AG1
(
  CP_NUMBER              VARCHAR2(100 BYTE)     NOT NULL,
  CP_DIV                 VARCHAR2(10 BYTE)      NOT NULL,
  ...
  CP_LANG_PREF           VARCHAR2(1 BYTE),
  CP_PLAN                VARCHAR2(10 BYTE)      NOT NULL,
