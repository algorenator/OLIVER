--
-- MEMBER_BENEFITS_ADJ  (Table) 
--
CREATE TABLE OLIVER.MEMBER_BENEFITS_ADJ
(
  ...
  ADMIN_RATE      NUMBER,
  AGENT_RATE      NUMBER,
  MEM_SALARY      NUMBER(12,2)                  DEFAULT 0,
  MEM_DEP_STATUS  VARCHAR2(1 BYTE),
  MEM_EFF_DATE    DATE,
  MEM_TERM_DATE   DATE,
  BILLING_DATE    DATE,
  MEM_CLASS       VARCHAR2(10 BYTE),
  ADMIN_AMT       NUMBER
)
TABLESPACE USERS
